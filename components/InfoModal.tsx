            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center justify-center text-sm text-neutral-300 mb-6 pb-4 border-b border-white/10 min-h-[100px]">
                             <h2 className="text-center text-3xl font-bold title-font text-yellow-400 mb-4">BẢNG PHÍM TẮT</h2>
                             {isLoading ? (
                                <div className="flex items-center justify-center h-full">
                                    <LoadingSpinnerIcon className="h-6 w-6 animate-spin text-yellow-400" />
                                </div>
                            ) : infoData && infoData.version ? (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 w-full">
                                    ...
                                    {infoData.videoTutorial && infoData.videoTutorial.linkUrl && (
                        ...
                        <div className="max-h-[65vh] overflow-y-auto pr-2">
                            <div className="text-neutral-300 columns-1 md:columns-2 xl:columns-3 gap-x-8">
                                {/* Section 1: General */}
                                <div className="break-inside-avoid mb-6">
                                    ...
                                    <ul className="space-y-2 text-sm">
                                        ...
                                        <li className="pt-2 border-t border-neutral-700/50"><span>{t('infoModal_usageTips_items.dragDrop')}</span></li>
                                    </ul>
                                </div>
                                ...
                                <div className="break-inside-avoid mb-6">
                                    ...
                                    <ul className="space-y-2 text-sm">
                                        ...
                                        <li className="flex justify-between items-center pt-2 border-t border-neutral-700/50"><span>{t('infoModal_usageTips_items.tempPicker')}</span> <Shortcut keys="Giữ Alt" /></li>
                                    </ul>
                                </div>
                                ...
                                <div className="break-inside-avoid mb-6">
                                    ...
                                    <ul className="space-y-2 text-sm">
                                        ...
                                        <li className="flex justify-between items-center pt-2 border-t border-neutral-700/50"><span>{t('infoModal_usageTips_items.quickDuplicate')}</span> <Shortcut keys="Giữ Alt + Kéo" /></li>
