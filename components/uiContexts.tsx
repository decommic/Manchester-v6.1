...
export const AppControlProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const [imagesForComposer, setImagesForComposer] = useState<string[] | null>(null);
    ...
    const openLayerComposer = useCallback((imageUrls?: string[]) => {
        setImagesForComposer(imageUrls || null);
    ...
    const clearImagesForComposer = useCallback(() => {
        setImagesForComposer(null);
    }, []);
