...
const AppComponents: Record<string, any> = {
    ...
    'pattern-designer': { Component: PatternDesigner, settingsKey: 'patternDesigner', props: (s:any, t:any) => ({ mainTitle: t(s.mainTitleKey), subtitle: t(s.subtitleKey), uploaderCaptionClothing: t(s.uploaderCaptionClothingKey), uploaderDescriptionClothing: t(s.uploaderDescriptionClothingKey), uploaderCaptionPattern1: t(s.uploaderCaptionPattern1Key), uploaderDescriptionPattern1: t(s.uploaderDescriptionPattern1Key), uploaderCaptionPattern2: t(s.uploaderCaptionPattern2Key), uploaderDescriptionPattern2: t(s.uploaderDescriptionPattern2Key) }) },
    'replace-product-in-scene': { Component: ReplaceProductInScene, settingsKey: 'replaceProductInScene', props: (s:any, t:any) => ({ mainTitle: t(s.mainTitleKey), subtitle: t(s.subtitleKey), uploaderCaptionProduct: t(s.uploaderCaptionProductKey), uploaderDescriptionProduct: t(s.uploaderDescriptionProductKey), uploaderCaptionScene: t(s.uploaderCaptionSceneKey), uploaderDescriptionScene: t(s.uploaderDescriptionSceneKey) }) },
};
        ...
        <main className="text-neutral-200 min-h-screen w-full relative">
            ...
            {isLayerComposerMounted && (
                <LayerComposerModal
                    ...
                    initialImages={imagesForComposer}
                    onInitialImagesConsumed={clearImagesForComposer}
                />
            )}
            <Footer />
        </main>
